    ...
    <>
          ...
          {data.featuredImage ? (
            <PopupFeatured>
              ...
              {data.featuredImageTitle ? (
                <div
                  dangerouslySetInnerHTML={{ __html: data.featuredImageTitle }}
                />
              ) : null}
              {data.featuredImageTextUnderTitle ? (
                <div
                  dangerouslySetInnerHTML={{
                    __html: data.featuredImageTextUnderTitle
                  }}
                />
              ) : null}
            </PopupFeatured>
            ...
            {data.dimensions?.map((el, index) => (
              <div key={el?.title + index}>
                <div className='image-wrap'>
                  <img
                    className='svg'
                    src={el?.image?.localFile?.publicURL}
                ...
                {el?.textUnderTitle ? (
                  <div
                    dangerouslySetInnerHTML={{ __html: el?.textUnderTitle }}
                  />
                ) : null}
              </div>
            ))}
      ...
      <Wrapper
        ...
        <svg
          ...
          width='9.513'
          height='17.37'
          viewBox='0 0 9.513 17.37'>
          <path
            id='Path_3'
            data-name='Path 3'
            d='M10052.275,8682.179l7.924,8.347-7.924,7.979'
            transform='translate(-10051.731 -8681.662)'
            fill='none'
            stroke='#31231e'
            strokeWidth='1.5'
          />
