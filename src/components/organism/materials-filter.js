        ...
        <Filter>
            <Container className="container">
                <div className="left">
                    ...
                    <DropDown controller={color} func={setColor} data={colorRange} controlTitle={'Color Range'} />
                    <DropDown controller={textures} func={setTextures} data={texturesArr} controlTitle={'Textures'} />
                    <DropDown controller={features} func={setFeatures} data={featuresArr} controlTitle={'Features'} />
                </div>
