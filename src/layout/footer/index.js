...
const leftColumnAnimation = {
  animate: { transition: { staggerChildren: 0.075, delayChildren: 0.5 } },
};
  ...
  return (
    <myContext.Consumer>
      {({ transition, setIsCookiesActive }) => {
        return (
          <Wrapper initial={isMobile ? 'animate' : 'initial'} animate={isSectionInView || isMobile ? 'animate' : 'initial'} exit="exit" ref={section} id="footer">
                ...
                <Menu>
                  ...
                  <Center>
                    <motion.div variants={leftColumnAnimation}>
                      ...
                      <motion.button
                        variants={leftLinkAnimation}
                        className="left styled-link"
                        onClick={() => {
                          setIsCookiesActive(true);
                        }}
                      >
                  ...
                  <Flex variants={socialColumnAnimation}>
                    <motion.a variants={socialAnimation} className="path" aria-label="facebook" href="https://www.facebook.com/sitseu" target="_blank" rel="noreferrer noopener me">
                    ...
                    <motion.a variants={socialAnimation} className="rect" aria-label="instagram" href="https://www.instagram.com/sits_furniture/" target="_blank" rel="noreferrer noopener me">
                    ...
                    <motion.a variants={socialAnimation} className="path" aria-label="youtube" href="https://www.youtube.com/@sits_furniture" target="_blank" rel="noreferrer noopener me">
