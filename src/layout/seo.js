...
export default function Seo({ language, isArchive = false, pageContext, seo, noindex = false }) {
    ...
    <>
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          url: siteUrl,
          sameAs: ['https://www.instagram.com/sits_furniture/', 'https://www.youtube.com/channel/UCrrbGKeNadbEzjNtwEQeazA', 'https://pl.pinterest.com/sitseu/', 'https://twitter.com/sitseu', 'https://www.facebook.com/sitseu/'],
          email: 'sits@sits.eu',
          contactPoint: {
            '@type': 'ContactPoint',
